...
- REST-02A creó `vicunav-restaurante` desde la plantilla canónica. REST-02B publicó el
  ...
  expiración y recálculo completo.
...
| `vicunav-restaurante` | Carrito seguro 0.8.0 y contrato 1.0.0; REST-02A a REST-02H completos | Plugin con comercio base, sesiones seguras, ownership, líneas, expiración, REST privado, CAS y totales autoritativos; será propietario de pedidos, reservas y reacción idempotente a pagos, sin WooCommerce | Ejecutar REST-02I: checkout transaccional, pedido y estados |
...
1. Ejecutar REST-02I a REST-02R en `vicunav-restaurante` según el
...
La siguiente acción del camino principal es REST-02I. THEME-REST-01 puede avanzar como
