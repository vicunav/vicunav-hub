...
| `vicunav-restaurante` | REST-02A a REST-02K completos; plugin 0.11.0, contrato 1.0.0, pedidos, pagos y reservas concurrentes, sin pizzas guardadas, bloques ni contenido de demo |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | REST-02L a REST-02R | `vicunav-restaurante` | Implementar pizzas guardadas, bloques y validación en 7 issues dependientes | REST-02K | REST-02L siguiente |
...
- REST-01 ya fijó el dominio sin WooCommerce, estados, totales, disponibilidad,
  permisos, endpoints y pruebas. REST-02A a REST-02H crearon el scaffold, el contrato
  de carga, la base de instalación, el menú, el catálogo, el pricing de pizzas, las
  zonas, los descuentos, las propinas y el cálculo autoritativo de totales; faltan
  carrito seguro y su recálculo concurrente; faltan pedidos y las demás reglas
  transaccionales, que no se marcaron como completadas.
