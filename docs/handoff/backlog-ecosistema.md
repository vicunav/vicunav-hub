...
| `vicunav-restaurante` | REST-02A a REST-02J completos; plugin 0.10.0, contrato 1.0.0, pedidos e integración pública idempotente con pagos, sin reservas ni contenido de demo |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | REST-02K a REST-02R | `vicunav-restaurante` | Implementar reservas, cuenta, bloques y validación en 8 issues dependientes | REST-02J | REST-02K siguiente |
