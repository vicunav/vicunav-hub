...
| `vicunav-restaurante` | REST-02A a REST-02G completos; plugin 0.7.0, contrato 1.0.0, menú, catálogo, disponibilidad, pricing de pizzas, zonas, descuentos, propinas y totales autoritativos, sin contenido de demo |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | REST-02H a REST-02R | `vicunav-restaurante` | Implementar carritos, pedidos, pagos, reservas, bloques y validación en 11 issues dependientes | REST-02G | REST-02H siguiente |
...
- REST-01 ya fijó el dominio sin WooCommerce, estados, totales, disponibilidad,
  permisos, endpoints y pruebas. REST-02A a REST-02G crearon el scaffold, el contrato
  ...
  carritos y las demás reglas transaccionales, que no se marcaron como completadas.
