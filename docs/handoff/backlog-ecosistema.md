...
| `vicunav-restaurante` | REST-02A y REST-02B completos; plugin 0.2.0, contrato público 1.0.0, autoload, comprobación de core y pagos, hook de carga, CI y protección de `main`, sin lógica de dominio |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | REST-02C a REST-02R | `vicunav-restaurante` | Implementar instalación, dominio, REST, administración, bloques y validación en 16 issues dependientes | REST-02B | REST-02C siguiente |
...
- REST-01 ya fijó el dominio sin WooCommerce, estados, totales, disponibilidad,
  permisos, endpoints y pruebas. REST-02A y REST-02B crearon el scaffold y el contrato
  de carga; falta implementar el dominio y no se marcó ningún comportamiento de
  negocio como completado.
